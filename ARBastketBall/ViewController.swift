...
//  ARBastketBall
//
//  Created by Jérémy on 28/11/2017.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    @IBOutlet weak var addHoopB: UIButton!
    ...
    @objc func handleTap(gestureRecognizer:UIGestureRecognizer){
        ...
        ballNode.physicsBody?.applyForce(SCNVector3(x: cameraOrientation.x * forceVector,
                                                    y: cameraOrientation.y * forceVector,
                                                    z: cameraOrientation.z * forceVector),
                                        asImpulse: true)
